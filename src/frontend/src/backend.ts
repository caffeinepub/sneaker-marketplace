...
export class Backend implements backendInterface {
    ...
    async createSneaker(arg0: Sneaker): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createSneaker(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteSneaker(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteSneaker(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllSneakers(): Promise<Array<Sneaker>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllSneakers();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSneaker(arg0: bigint): Promise<Sneaker> {
        if (this.processError) {
            try {
                const result = await this.actor.getSneaker(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async placeOrder(arg0: Array<OrderItem>, arg1: bigint): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async updateSneaker(arg0: Sneaker): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateSneaker(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
